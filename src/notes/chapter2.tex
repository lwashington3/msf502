\documentclass[
	lecture={2},
	title={Tabular and Graphical Methods}
]{msf502notes}
...
\begin{objectives}
	\item Summarize qualitative data by forming frequency distributions.
	\item Construct and interpret pie charts and bar charts.
	\item Summarize quantitative data by forming frequency distributions.
	\item Construct and interpret histograms, polygons, and ogives.
	\item Construct and interpret a stem-and-lead diagram.
	\item Construct and interpret a scatterplot.
\end{objectives}

\section{Summarizing Qualitative Data}\label{sec:summarizing-qualitative-data}
\lo{Summarize qualitative data by forming frequency distributions.}
...
\section{Summarizing Quantitative Data}\label{sec:summarizing-quantitative-data}
\lo{Summarize quantitative data by forming frequency distributions.}
