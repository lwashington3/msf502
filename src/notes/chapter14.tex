...
\begin{itemize}
	...
	\item Since the predictions cannot be totally accurate, the difference between the predicted and actual value represents the \emph{residual} $e = y - \hat{y}$.
\end{itemize}
...
\begin{itemize}
	...
	\end{equation}
	where $SSE$ is~\eqref{eq:sse-2} and $SST$ is~\eqref{eq:sst}
	\begin{equation}
