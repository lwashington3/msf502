...
\begin{itemize}
	\item $F_{(df_{1}, df_{2})}$ distribution is a family of distributions, each one is define by two degrees of freedom parameters, one for the numerator and one for the denominator.
...
\lo{Use confidence intervals and Tukey's HSD method in order to determine which means differ.}
\begin{itemize}
...
\section{Two-Way ANOVA \w\ Interactions}\label{sec:two-way-anova-w-interactions}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|*{4}{r|}}
		...
		\hline
		Ph.D. & 75 & 90 & 110 & 91.67\\
		\hline
		Factor A Means & 43.50 & 54.50 & 60.25 & 52.75\\
		\hline
	\end{tabular}
\end{table}
